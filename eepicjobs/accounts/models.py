...
class UserProfile(models.Model):
    ...
    school= models.CharField(max_length=255, null=True, verbose_name='Mention Your Education Details')
    college = models.CharField(max_length=255, null=True, verbose_name='Mention Your Education Details')
    tenth_percentage = models.DecimalField(max_digits=3, decimal_places=2,default=0)
    yop_for_tenth= models.IntegerField(blank=True, null=True)
    twelth_percentage = models.DecimalField(max_digits=3, decimal_places=2,default=0)
    yop_for_twelfth = models.IntegerField(blank=True, null=True)
    bachelor_degree=models.CharField(max_length=255, null=True, verbose_name='Mention Your Education Details')
    yop_for_bachelors= models.IntegerField(blank=True, null=True)
    CGPA_For_bachelors = models.DecimalField(max_digits=2, decimal_places=2,default=0)
    masters_degree = models.CharField(max_length=255, null=True, verbose_name='Mention Your Education Details')
    yop_for_masters = models.IntegerField(blank=True, null=True)
    CGPA_For_masters = models.DecimalField(max_digits=2, decimal_places=2,default=0)
    hobbies=models.CharField(max_length=255, null=True, verbose_name='Mention Your Education Details')
    ...
    hackkerank = models.URLField(blank=True, null=True)
